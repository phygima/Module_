...
void saveListToFile(Contact* head, const char* filename){
...
void readListFromFile(Contact** head_ref, const char* filename){
...
Contact* parse_line_to_contact(const char *line) {
    char *first_name = strtok(line, " \n");
    char *last_name = strtok(NULL, " \n");
    char *work_place = strtok(NULL, " \n");
    char *position = strtok(NULL, " \n");
    char *phone = strtok(NULL, " \n");
    char *email = strtok(NULL, " \n");
    char *social = strtok(NULL, " \n");

    return create_contact(first_name, last_name, work_place, position, phone, email, social);
}
...
//         Contact* new_contact = parse_line_to_contact(buffer);
//         add_contact(head_ref, new_contact);
//     }
